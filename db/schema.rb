...
ActiveRecord::Schema[8.1].define(version: 2026_02_24_065749) do
  ...
  create_table "ahoy_events", force: :cascade do |t|
    ...
    t.datetime "time"
    t.bigint "visit_id"
    t.index ["member_id"], name: "index_ahoy_events_on_member_id"
  ...
  create_table "ahoy_visits", force: :cascade do |t|
    ...
    t.index ["member_id"], name: "index_ahoy_visits_on_member_id"
